...
* You’ve got double-quotish variable interpolation, though it
  `"looks #{like} this"` (and you can put any Ruby code you like inside that
  `#{}`).
* Shell command expansion uses \`backticks\`.
* You’ve got embedded doc tools (Ruby’s default is called rdoc, there
  are some others available as well).
